// src/pages/seller/SellerLoginPage.jsx
// Maesai Market — Seller Login
...
import sellerApi, { setToken } from '../../api/seller.api';
import FormInput from '../../components/shared/FormInput';
import BackButton from '../../components/shared/BackButton';

export default function SellerLoginPage({ navigate, onLoginSuccess }) {
  ...
  async function handleSubmit(e) {
    ...
    setLoading(true);
    try {
      const res = await sellerApi.post('/auth/seller/login', { identifier, password });
      // Backend returns { success, data: { accessToken, refreshToken, seller } }
  ...
  return (
    <div className="page-container">
      <div className="top-bar">
        ...
        <span className="top-bar-title">{t('landing.seller')}</span>
        <div style={{ width: 32 }} />
      </div>
